...
/**
 * Normalizes extracted text for consistent line indexing and evidence grounding:
 * 1. Standardizes CRLF and CR to standard LF newlines.
 ...
 *    to preserve readability without ballooning line count.
 */
